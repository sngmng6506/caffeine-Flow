...
const styles = {
  ...
  desc: { fontSize: 12, color: '#667085', lineHeight: 1.45 },
  stateBadge: { flexShrink: 0, padding: '6px 10px', borderRadius: 999, border: '1px solid', fontWeight: 800, fontSize: 11 },
  stateOn: { borderColor: '#f1cf8f', background: '#fffaeb', color: '#8a5d00' },
  stateOff: { borderColor: '#e4e7ec', background: '#f9fafb', color: '#667085' },
  ...
  saveBtn: { minHeight: 40, padding: '9px 20px', borderRadius: 8, background: '#1f2937', color: '#fff', border: 'none', cursor: 'pointer', fontWeight: 700, fontSize: 13 },
  ...
  testBtn: { minHeight: 40, padding: '9px 14px', borderRadius: 8, background: '#1f2937', color: '#fff', border: 'none', cursor: 'pointer', fontWeight: 700, fontSize: 13, whiteSpace: 'nowrap' },
