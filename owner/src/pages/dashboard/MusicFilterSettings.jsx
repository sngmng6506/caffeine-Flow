...
const styles = {
  ...
  advancedSection: { background: '#fff', border: '1px solid var(--owner-stroke)', borderRadius: 8, overflow: 'hidden' },
  advancedSummary: { padding: '14px', cursor: 'pointer', fontSize: 13, fontWeight: 700, color: '#475467' },
  advancedBody: { padding: '2px 14px 14px', borderTop: '1px solid var(--owner-stroke)' },
  ...
  info: { flex: '1 1 320px', padding: 12, borderRadius: 8, border: '1px solid var(--owner-stroke)', background: '#f9fafb', color: '#667085', fontSize: 12, lineHeight: 1.45 },
