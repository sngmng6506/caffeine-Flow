...
// 외부 음악 페이지에서 감지한 공개 현재 곡 메타데이터 한도.
const PLAYBACK_TRACK_TEXT_MAX_LENGTH = 200;
const PLAYBACK_THUMBNAIL_URL_MAX_LENGTH = 2048;
const MEANINGFUL_PLAYBACK_SECONDS = 60;
const QR_CUSTOMER_URL_MAX_LENGTH = 2048;
const QR_IMAGE_MAX_BYTES = 1_000_000;
