...
| 플랫폼 운영자 콘솔 이해 | [admin/README.md](../admin/README.md) |
...
| 사장님 화면 디자인 기준 | [owner/DESIGN_GUIDE.md](../owner/DESIGN_GUIDE.md) |
| 사장님 화면 문구 기준 | [owner/WRITING_GUIDE.md](../owner/WRITING_GUIDE.md) |
...
- `admin/README.md`: 플랫폼 운영자 콘솔의 화면, 상태, API 경계
...
- `owner/DESIGN_GUIDE.md`: 사장님 화면의 Calm Operations 시각·컴포넌트 기준
- `owner/WRITING_GUIDE.md`: 사장님 화면의 목소리·용어·UI 문구 기준
